...
<div class="header">
	<div class="container">
		<div class="logo wow fadeInDown animated" data-wow-delay=".5s">
			<a href="index.php">Rental <span>Mobil</span> Honai</a>	
		</div>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-1">
						...
						<li><a href="bus.php">Daftar Mobil</a></li>
...
<div class="container">
	...
	<div class="col-md-7 bann-info wow fadeInRight animated" data-wow-delay=".5s">
		<h2 style="background: #EAEAEA; text-align: center; padding: 5px;">Rental Mobil Murah dengan Harga Terjangkau</h2>
		<div class="ban-top">
			<div class="bnr-left">
...
<div class="copy-right">
	<div class="container">
		...
		<p class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Honai Car © 2021-2022  </p>
	</div>
</div>
<!--- /copy-right ---->
<!-- sign -->
